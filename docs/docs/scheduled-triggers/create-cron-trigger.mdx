...
REST Connectors i.e. request and response transformations, for cron triggers are used to invoke existing or third-party
webhooks without needing any middleware or modifications to the upstream code.
